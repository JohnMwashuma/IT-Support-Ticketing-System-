...
namespace ITSUPPORTTICKETSYSTEM.Areas.Admin.Controllers
{
    ...
    public class ClosedTicketsController : Controller
    {
        private const int TicketsPerPage = 5;
        //
        // GET: /Admin/ClosedTickets/

        public ActionResult Index(string searchBy, string search, int page = 1)
        {

            var totalTicketCount = Database.Session.Query<Ticket>().Count();
            ...
            return View(new ClosedTicketsIndex()
            {
